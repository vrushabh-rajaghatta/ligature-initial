// Empty when unset, never undefined: every path below already begins with
// "/api", so an empty base resolves to the origin the page was served from,
// which is correct behind a single reverse proxy. Interpolating an undefined
// base instead produces the literal "undefined/api/..." — a request that fails
// with a URL nobody recognises as a configuration mistake.
