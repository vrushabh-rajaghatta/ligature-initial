...
/// developer runs with and seeds <c>dev@acme.local</c>, which is the only
...
/// </para>
/// </remarks>
public sealed class AcmeApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    /// <summary>
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("ConnectionStrings:Acme", _database.ConnectionString);
