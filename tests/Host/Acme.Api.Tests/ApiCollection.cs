...
/// </remarks>
public sealed class ApiDatabase : AcmeTestDatabase;
...
/// <see cref="AcmeApiFactory"/> rather than declared beside it, because xUnit 2
/// will not inject one collection fixture into another — see that class for what
/// the attempt costs.
/// </para>
/// </remarks>
[CollectionDefinition(Name)]
public sealed class ApiCollection : ICollectionFixture<AcmeApiFactory>
{
    public const string Name = "Acme API";
}
