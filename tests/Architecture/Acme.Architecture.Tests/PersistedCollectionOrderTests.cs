...
public class PersistedCollectionOrderTests
{
    ...
    {
        DomainSourceFiles().Should().HaveCountGreaterThan(20,
            "Acme has two bounded contexts of domain source; a much smaller "
            + "number means the scan stopped finding domain source rather "
            + "than that the domain shrank");
    }
