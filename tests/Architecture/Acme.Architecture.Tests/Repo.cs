...
{
    /// <summary>The repository root, found by walking up to Acme.slnx.</summary>
    ...
    private static string FindRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "Acme.slnx")))
        ...
        throw new InvalidOperationException(
            "Could not locate Acme.slnx above " + AppContext.BaseDirectory
