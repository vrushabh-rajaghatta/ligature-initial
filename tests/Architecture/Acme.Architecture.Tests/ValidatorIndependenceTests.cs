...
/// Acme's reading of a specification — never to define it.
/// </summary>
/// <remarks>
...
/// disagreeing with Acme; a parser Acme consults cannot disagree with it.
/// </para>
/// <para>
...
public class ValidatorIndependenceTests
{
    ...
    public void NoCodeInSrc_ReadsAVerdictFromAValidator()
    {
        ...
        offenders.Should().BeEmpty(
            ...
            + "seam between Acme and any validator is the filesystem, and a "
