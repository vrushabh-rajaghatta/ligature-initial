...
/// </para>
/// </remarks>
public abstract class AcmeTestDatabase : IAsyncLifetime
{
    private ServiceProvider? _services;
    private bool _disposed;

    protected AcmeTestDatabase()
    {
        ...
        Options = new DbContextOptionsBuilder<AcmeDbContext>()
    ...
    /// </remarks>
    private async Task GuardTheSchemaCameFromTheChainAsync(AcmeDbContext context)
    {
    ...
    /// <summary>
    /// <c>acme_test_&lt;assembly&gt;_&lt;short guid&gt;</c>, and the truncation is
    ...
    private static string DatabaseName(string? assemblyName)
    {
        var slug = (assemblyName ?? "unknown")
            .Replace("Acme.", string.Empty, StringComparison.Ordinal)
