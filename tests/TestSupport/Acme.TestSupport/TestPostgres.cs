...
/// test assembly by <see cref="AcmeTestDatabase"/>; what lives here is only how
...
/// that must exist before any Acme database does.
/// </para>
/// </remarks>
public static class TestPostgres
{
    ...
    /// </summary>
    public const string ServerVariable = "ACME_TEST_POSTGRES";

    /// <summary>
    /// The local development Postgres, which is what every Acme developer runs
