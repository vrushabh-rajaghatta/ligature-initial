...
namespace Acme.Api.Development;

/// <summary>
/// Creates one platform user — a person who operates Acme itself and belongs
...
{
    public const string EmailAddress = "platform@acme.local";
