...
/// stricter than <c>Lax</c> — a link from an external site into Acme lands
...
{
    public const string AccessToken = "acme_access";
    public const string RefreshToken = "acme_refresh";
