...
The Implementation Standards define how the Acme architecture is translated into software.
...
When multiple valid implementation approaches exist, prefer the one that is already established within Acme.
...
> `Acme.Platform.Application.Tests`, where the EF model is available). It
